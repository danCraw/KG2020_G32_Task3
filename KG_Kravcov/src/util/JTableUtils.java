...
public class JTableUtils {
    ...
    private static void getParameterValue(String parameter, JTable table) {
//        Object[][] arr = toArr(table);
    }

    public static void toArr(JTable table) {
        Object[] arr = new Object[table.getRowCount()];
        for (int i = 0; i < arr.length; i++) {
            arr[i] = table.getValueAt(i, 1);
        }
    ...
    public static Object[][] readObjMatrixFromJTable(JTable table) {
